...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private void populateTabStrip() {
        final MainActivity.MyAdapter adapter = (MainActivity.MyAdapter) mViewPager.getAdapter();
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            tabImageView.setImageDrawable(getResources().getDrawable(adapter.getDrawable(i)));
            ...
            LinearLayout layout = (LinearLayout) tabView.findViewById(R.id.linear);

            WindowManager wm = (WindowManager) getContext().getSystemService(Context.WINDOW_SERVICE);
            Display display = wm.getDefaultDisplay();
            Point size = new Point();
            display.getSize(size);
            layout.getLayoutParams().width = size.x / adapter.getCount();
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            MainActivity.setMyTitle(position);
